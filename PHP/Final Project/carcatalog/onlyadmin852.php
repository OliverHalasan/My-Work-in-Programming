...
if (isset($_POST['submit']))
{
    ...
    if ($user_names || $email)
    {
        $check_sql = "SELECT user_id FROM user2 WHERE (email = '$email' OR user_names = '$user_names') AND deleted_yn = 'N' ";
    ...
    //inser into db
    {
        ...
        $sql = "INSERT INTO user2 (first_name, last_name, user_names, password, email) 
