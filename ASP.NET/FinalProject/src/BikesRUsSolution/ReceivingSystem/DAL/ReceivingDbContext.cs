...
{
    internal partial class ReceivingDbContext : DbContext
    {
        public ReceivingDbContext()
        {
        }

        public ReceivingDbContext(DbContextOptions<ReceivingDbContext> options)
            : base(options)
        {
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<UnorderedPurchaseItemCart>(entity =>
            {
                entity.HasKey(e => e.CartID)
                    .HasName("PK__Unordere__51BCD797C3F6FF06");
            });
